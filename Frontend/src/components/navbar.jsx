...
function Navbar() {const [authUser, setAuthUser] = useAuth();
  // const {user} = useAuth();
  ...
  const navItem = (
    <>
      <li className="rounded-md hover:bg-orange-500 duration-300 cursor-pointer dark:hover:bg-slate-800 ">
        <a href="/"> <img src={home} alt="" /> Home </a>
      </li>
      <li className="rounded-md hover:bg-orange-500 duration-300 cursor-pointer dark:hover:bg-slate-800 ">
        <a href="/about"> <img src={about} alt="" />About Us! </a>
      </li>
      {authUser && (
      <li className="rounded-md hover:bg-orange-500 duration-300 cursor-pointer dark:hover:bg-slate-800">
      ...
      <li className="rounded-md hover:bg-orange-500 duration-300 cursor-pointer dark:hover:bg-slate-800">
        <a href="/tasks"><img src={task} alt="" /> Tasks </a>
      </li>
    </>
  );
  return (
    <div
      ...
      <div className="navbar ">
        <div className="navbar-start">
          ...
          <img
             className="md:w-200 md:h-200 w-200 h-200"
            alt="Tailwind CSS Navbar component"
            src="https://ugc.production.linktr.ee/Tcnq74hpQ2S5Y5c7UmHB_tPAy21K3f5P5KFGO" />
        </div>
          <a className=" text-2xl font-bold cursor-pointer">AAVHAN</a>
        </div>
